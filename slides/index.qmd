...
Listing available on the {cards} website: [https://insightsengineering.github.io/cards/latest-tag/#other-resources](https://insightsengineering.github.io/cards/latest-tag/#other-resources)
...
Best resource is the {gtsummary} website with almost 10 vignettes
...
- {crane} R package
    ...
    - There is a lot there already, and we anticipate its first official release this Fall. [https://insightsengineering.github.io/crane/main/](https://insightsengineering.github.io/crane/main/)
...
- Cardinal Initiative
    ...
    - Check out the progress at [https://pharmaverse.github.io/cardinal/](https://pharmaverse.github.io/cardinal/)
...
tbl_ard <- 
  ...
  tbl_summary(
    ...
    type = AGE ~ "continuous2",
    statistic = AGE ~ c("{mean} ({sd})", "{median} ({p25}, {p75})"),
    digits = AGEGR1 ~ list(p = label_style_number(digits = 1, scale = 100))
  ) |> 
  gather_ard() |> 
...
- Due to the {gtsummary} package's popularity, the publicly available LLMs can be used to write code to create tables
...
An entire table has a representation that is readily digestable by your favorite LLM.
